    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredItems.map((item, index) => (
          ...
          >
            <div className="relative h-48 md:h-56 lg:h-64 overflow-hidden group">
              <Image
                src={item.image}
                alt={item.name}
                layout="fill"
                objectFit="cover"
                className="transition-transform duration-300 group-hover:scale-110 group-hover:translate-y-4"
              />
            </div>
            <div className="p-4">
