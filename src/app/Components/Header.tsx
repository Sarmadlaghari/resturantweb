  ...
  return (
    <header className="bg-white shadow-md">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <Link href="/" className="text-3xl font-bold text-red-500 font-display">
          Epicurean Delight
        </Link>
        <nav className="hidden md:block">
          <ul className="flex space-x-6">
            <li><Link href="/" className="text-black-800 font-bold hover:text-red-600 transition-colors">Home</Link></li>
            <li><Link href="/menu" className="text-black-800 font-bold hover:text-red-600 transition-colors">Menu</Link></li>
            <li><Link href="/about" className="text-black-800 font-bold hover:text-red-600 transition-colors">About</Link></li>
            <li><Link href="/contact" className="text-black-800 font-bold hover:text-red-600 transition-colors">Contact</Link></li>
            <li>
              <button 
                onClick={() => setIsNewsletterVisible(true)}
                className="text-black-800 font-bold hover:text-red-600 transition-colors"
              >
                Newsletter
              </button>
            </li>
